# Autogenerated wrapper script for NL2sol_jll for x86_64-unknown-freebsd11.1-libgfortran5
export libnl2sol
...
const libnl2sol_splitpath = ["lib", "libnl2sol.so"]
