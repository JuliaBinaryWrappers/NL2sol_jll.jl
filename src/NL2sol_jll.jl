...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import NL2sol_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("49fe2e30-ebaf-52e2-a844-d04adb473700"))
platforms = [Pkg.Artifacts.unpack_platform(e, "NL2sol", artifacts_toml) for e in artifacts["NL2sol"]]
...
if best_platform === nothing
    @debug("Unable to load NL2sol; unsupported platform $(triplet(platform_key_abi()))")
else
